 ...
 */
package info.javaknowledge.projectstarter.configuration;
...
//    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "info.javaknowledge.projectstarter.domain" });
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/tsp");
